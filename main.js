...
//     renderer = new THREE.WebGL3DRenderTarget({ antialias: true, alpha: true});
//     renderer.setPixelRatio( window.devicePixelRatio );
//     renderer.setSize( window.innerWidth, window.innerHeight);
//     renderer.xr.enabled = true;
//     container.appendChilid( renderer.domElement);
...
//         mesh.position.setFromRotationMatrix( controller.matrixWorld);
//         scene.add (mesh);
//     }
